...
analysis_data_human |>
  ...
  summarise(
    ...
    IQR_report_length    = IQR(report_length, na.rm = TRUE),
    q1                   = quantile(report_length, 0.25, na.rm = TRUE),
    q3                   = quantile(report_length, 0.75, na.rm = TRUE)
  ) |>
  tt(width = 1)
```
